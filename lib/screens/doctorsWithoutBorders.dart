...
class DoctorsWithoutBorders extends ConsumerStatefulWidget {
  const DoctorsWithoutBorders({super.key});

  @override
  ConsumerState<DoctorsWithoutBorders> createState() =>
      _DoctorsWithoutBordersState();
}

class _DoctorsWithoutBordersState extends ConsumerState<DoctorsWithoutBorders> {
  List<int> b = [];
                        ...
                        Padding(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              ref.watch(dataStateProvider1.notifier).addData(b);
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              if (a.length == 5) {
                                ref
                                    .watch(dataStateProvider1.notifier)
                                    .addData(a);
                                setState(() {
                                  a = [];
                                  c = Colors.white;
