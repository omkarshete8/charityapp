...
class TheNatureConservancy extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TheNatureConservancy> createState() =>
      _TheNatureConservancyState();
}
                        ...
                        Padding(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              ref.watch(dataStateProvider3.notifier).addData(b);
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              if (a.length == 5) {
                                ref
                                    .watch(dataStateProvider3.notifier)
                                    .addData(a);
                                setState(() {
                                  a = [];
                                  c = Colors.white;
